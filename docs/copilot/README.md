...
| Phase | 文档 | 状态 | 依赖 |
|---|---|---|---|
| 0 | [skland-box](phase-0-skland-box.md) | in_progress（6/7 done，待真实验收） | 无 |
...
当前只推进 Phase 0：Skland Box 与交互式登录。未通过真实账号验收不进入 Phase 1。Phase 0–2 不启动游戏；Phase 3 起真实战斗另需用户明确指定关卡和授权。
